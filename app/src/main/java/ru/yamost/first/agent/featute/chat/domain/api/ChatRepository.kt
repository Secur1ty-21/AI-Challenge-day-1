...
interface ChatRepository {
    suspend fun getAnswer(messageList: List<Message>, temperature: Float): YaResult<Answer, Unit>
    suspend fun summary(messageList: List<Message>): YaResult<Answer, Unit>
}